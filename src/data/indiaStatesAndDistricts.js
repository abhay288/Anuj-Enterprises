/**
 * Comprehensive Data Map of all 28 States & 8 Union Territories of India with Districts
 * Useful for Address dropdowns, Billing/Shipping territory mapping, and Salesman route planning.
 */
...
export const INDIA_STATES_AND_DISTRICTS = {
  ...
  "Bihar": [
    ...
    "Sheohar", "Sitamarhi", "Siwan", "Supaul", "Vaishali", "West Champaran (Bettiah)"
  ],
  "Chhattisgarh": [
    ...
    "Kanker (North Bastar)", "Khairagarh-Chhuikhadan-Gandai", "Kondagaon", "Korba", 
  ...
  "Jharkhand": [
    ...
    "Sahebganj", "Seraikela Kharsawan", "Simdega", "West Singhbhum (Chaibasa)"
  ],
  "Karnataka": [
    "Bagalkot", "Ballari (Bellary)", "Belagavi (Belgaum)", "Bengaluru Rural", "Bengaluru Urban", 
    "Bidar", "Chamarajanagar", "Chikkaballapur", "Chikkamagaluru", "Chitradurga", 
    "Dakshina Kannada (Mangaluru)", "Davanagere", "Dharwad", "Gadag", "Hassan", 
  ...
  "Madhya Pradesh": [
    ...
    "Mandla", "Mandsaur", "Morena", "Mauganj", "Narsinghpur", "Neemuch", "Niwari", 
  ...
  "Rajasthan": [
    ...
    "Deeg", "Didwana-Kuchaman", "Dholpur", "Dudu", "Dungarpur", "Gangapur City", 
  ...
  "Sikkim": [
    "Gangtok", "Gyalshing (West Sikkim)", "Mangan (North Sikkim)", 
  ...
  "Tamil Nadu": [
    ...
    "Nilgiris (Udhagamandalam/Ooty)", "Perambalur", "Pudukkottai", "Ramanathapuram", 
  ...
  "Uttar Pradesh": [
    ...
    "Gorakhpur", "Hamirpur", "Hapur", "Hardoi", "Hathras", "Jalaun (Orai)", "Jaunpur", 
    "Jhansi", "Kannauj", "Kanpur Dehat", "Kanpur Nagar (Kanpur HQ)", "Kasganj", 
  ...
  "West Bengal": [
    ...
    "Paschim Bardhaman (West Burdwan)", "Paschim Medinipur (West Midnapore)", 
    "Purba Bardhaman (East Burdwan)", "Purba Medinipur (East Midnapore)", 
