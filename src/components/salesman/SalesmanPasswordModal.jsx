...
export const SalesmanPasswordModal = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.success) {
        showToast(res.message || 'Salesman password successfully updated in database!', 'success');
        setOldPassword('');
        setNewPassword('');
        setConfirmPassword('');
        onClose();
  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md overflow-y-auto">
        ...
        >
          {/* Header Banner */}
          <div className="bg-gradient-to-r from-brand-950 via-slate-900 to-amber-950 text-white p-6 relative">
            <button
              type="button"
              onClick={onClose}
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <span className="text-xs text-amber-400 font-bold block">
                  Salesman ID: {user?.salesmanId || user?.name || 'AE-SM-001'}
                </span>
              </div>
            </div>
            <p className="text-xs text-slate-300">
              Verify your current password and create a new secure password for field order authorization.
            </p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="Enter current salesman password..."
